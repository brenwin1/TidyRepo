...
Luckily, we came across this coffee ratings data set from `#TidyTuesday` challenge, we knew we had to analyze the data. Data set consist of scores from coffee cupping(tasting) done by professionals (although one doesn't have to be a professional to do so).  
